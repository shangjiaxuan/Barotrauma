...
namespace Barotrauma
{
    ...
    static partial class DebugConsole
    {
        ...
        private static void SpawnCharacter(string[] args, Vector2 cursorWorldPos, bool usePreConfiguredNPC = false)
        {
            ...
            {
                Entity.Spawner.AddCharacterToSpawnQueue(args[0].ToIdentifier(), spawnPosition, prefab.HasCharacterInfo ? new CharacterInfo(new PrefabInstance(prefab.Identifier, "")) : null, onSpawn: SetTeamAndCrew);
            }
